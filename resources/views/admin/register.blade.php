...
@endif
              <form class="pt-3" action="{{url('admin/register')}}" method="post">
                @csrf
                <div class="form-group">
                    <input type="name" name="name" id="name"  class="form-control form-control-lg" id="exampleInputName" placeholder="Username"  required=''>
                  </div>
                <div class="form-group">
                  <input type="email" name="email" id="email"  class="form-control form-control-lg" id="exampleInputEmail1" placeholder="email"  required=''>
                </div>
                <div class="form-group">
                    <input type="text" name="mobile" id="mobile"  class="form-control form-control-lg" id="exampleInputMobile" placeholder="Mobile"  required=''>
                  </div>
                <div class="form-group">
